        ...
        <div class="card p-4">
            <div class="row">
                ...
                <div class="col text-end">
                  {{--   <a href="{{ route('edit', ['id' => Crypt::encrypt($note['id'])]) }}" class="btn btn-outline-secondary"></a>"></a>
                    <a href="{{ route('edit', ['id' => Crypt::encrypt($note['id'])]) }}" class="btn btn-outline-danger btn-sm"></a> --}}
            ...
            {{-- este campo poder ser o de trazer nas notas qque estçaoi no abanco de dados e adicionar o crud --}}
        </div>
    </div>
</div>
